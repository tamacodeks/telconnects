...
@if ($hasFlixBooking)
    @include('v2.service.bus.partials.flix-booking')
@elseif ($hasBlaBooking)
    @include('v2.service.bus.partials.bla-booking')
@elseif ($hasResults)
    @if ($hasRoundTripResults)
        @include('v2.service.bus.partials.roundtrip-results')
    @else
        @include('v2.service.bus.partials.results')
    @endif
@else
    @include('v2.service.bus.partials.empty-state')
@endif
