    ...
    <div>
        @php
            ...
            $v2SidebarActivePathMap = [
                ...
                'users' => ['users', 'users-v2', 'fetch/users'],
                'users-v2' => ['users-v2', 'users', 'users-v2/fetch', 'fetch/users'],
                'user_info' => ['user_info', 'user-info-v2', 'fetch/users_info'],
                'user-info-v2' => ['user-info-v2', 'user_info', 'user-info-v2/fetch', 'fetch/users_info'],
                'all_users' => ['all_users', 'all-users-v2', 'fetch_all_users'],
                'all-users-v2' => ['all-users-v2', 'all_users', 'all-users-v2/fetch', 'fetch_all_users'],
                'refresh_popup_seen_users' => ['refresh_popup_seen_users', 'refresh-popup-seen-users-v2', 'fetch_refresh_popup_seen_users'],
                'refresh-popup-seen-users-v2' => ['refresh-popup-seen-users-v2', 'refresh_popup_seen_users', 'refresh-popup-seen-users-v2/fetch', 'fetch_refresh_popup_seen_users'],
                'user-groups' => ['user-groups', 'user-groups-v2', 'fetch/user-groups', 'user-group/update', 'user-group/remove'],
                'user-groups-v2' => ['user-groups-v2', 'user-groups', 'user-groups-v2/fetch', 'fetch/user-groups', 'user-group/update', 'user-group/remove'],
            ...
            $v2SidebarActiveActionMap = [
                ...
                'users' => ['V2\UserController@*', 'App\UserController@index', 'App\UserController@getRowDetailsData'],
                'users-v2' => ['V2\UserController@*', 'App\UserController@index', 'App\UserController@getRowDetailsData'],
                'user_info' => ['V2\UserController@*', 'App\UserController@user_info', 'App\UserController@getIpData'],
                'user-info-v2' => ['V2\UserController@*', 'App\UserController@user_info', 'App\UserController@getIpData'],
                'all_users' => ['V2\UserController@*', 'App\UserController@all_users', 'App\UserController@fetch_all_users'],
                'all-users-v2' => ['V2\UserController@*', 'App\UserController@all_users', 'App\UserController@fetch_all_users'],
                'refresh_popup_seen_users' => ['V2\UserController@*', 'App\UserController@refresh_popup_seen_users', 'App\UserController@fetch_refresh_popup_seen_users'],
                'refresh-popup-seen-users-v2' => ['V2\UserController@*', 'App\UserController@refresh_popup_seen_users', 'App\UserController@fetch_refresh_popup_seen_users'],
                'user-groups' => ['V2\UserGroupController@*', 'App\UserGroupController@index', 'App\UserGroupController@getUserGroups'],
                'user-groups-v2' => ['V2\UserGroupController@*', 'App\UserGroupController@index', 'App\UserGroupController@getUserGroups'],
            ...
            $v2SidebarSectionMap = [
                ...
                'users-v2' => 'settings',
                'user_info' => 'settings',
                'user-info-v2' => 'settings',
                'all_users' => 'settings',
                'all-users-v2' => 'settings',
                'refresh_popup_seen_users' => 'settings',
                'refresh-popup-seen-users-v2' => 'settings',
                'user-groups' => 'settings',
                'user-groups-v2' => 'settings',
                'menus' => 'settings',
                'menus-v2' => 'settings',
