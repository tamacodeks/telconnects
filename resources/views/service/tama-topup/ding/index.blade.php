                                ...
                                <form id="frmDingTopup" class="form-horizontal">
                                    <div class="form-group ">
                                        <label class="control-label col-md-4"
                                               for="operator">{{ trans('sale.mobile_number') }}</label>
                                        <div class="col-md-8">
                                            <h4>+{{ $mobile_number }}
                                                <a href="{{ secure_url('tama-topup') }}" style="font-size: 14px;margin-left: 20px;">{{ trans('tamatopup.change_number') }}</a></h4>
                                            <input class="form-control" id="mobile" name="mobile" type="hidden" value="+{{ $mobile_number }}">
                                            ...
                                            <input type="hidden" id="countryIso" name="countryIso" value="{{ $countryIso }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group hide" id="gridProviderDiv">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="hidden" name="_hid_provider_country" id="_hid_provider_country">
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" name="_hid_euro_amount" id="_hid_euro_amount_formatted">
                                    <input type="hidden" name="_hid_dest_amount" id="_hid_dest_amount">
                                    <input type="hidden" name="_hid_dest_amount" id="_hid_dest_amount_formatted">
                                    ...
                                    <div class="form-group hide" id="divRangeAmount">
                                        ...
                                        <div class="col-md-8">
                                            <div id="betweenDenomination" style="margin-bottom: 5px;font-weight: 600;"></div>
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <img src="{{ secure_asset('images/coins-icon.png') }}" style="width: 20px;opacity: .5;">
                                                </span>
                                                <input id="range_amount" type="text" class="form-control" min="1" max="1" name="range_amount" placeholder="">
                                            ...
                                            <div style="margin-top: 5px;display: none" id="amountReceivedDiv"><span id="amountReceived" style="font-size: 16px;font-weight: 600;"></span> {{ trans('tamatopup.will_be_received') }}  <span id="ifTaxApplicable" style="display: none;">Inc. <span id="taxName"></span></span></div>
                                        </div>
                                    </div>
                                    <div class="form-group hide" id="summaryDiv">
                                        <label class="control-label col-md-4">&nbsp;</label>
                                        <div class="col-md-8" style="margin-top: 50px">
                                            <button class="btn btn-primary" id="reviewOrderBtn" type="button"><i class="fa fa-check-circle"></i>&nbsp;{{ trans("tamatopup.review_order_summary") }}</button>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#frmDingTopup").submit(function (e) {
                ...
                getProviders(api_base_url+"/tama-topup/fetch/providers?accountNumber="+mobileNumber+"&countryCode="+countryCode+"&countryIsos="+countryIso);
            });
            ...
            $("#reviewOrderBtn").click(function () {
                ...
                {
                    AppModal("{{ secure_url('tama-topup/review?') }}"+query,"ORDER SUMMARY");
                }else{
                    $.alert({
                        title: 'Information',
