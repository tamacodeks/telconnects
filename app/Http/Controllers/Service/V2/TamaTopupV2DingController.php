...
class TamaTopupV2DingController extends TamaTopupV2BaseController
{
        ...
        try {
            switch ($operation) {
                case 'providers':
                    ...
                    $result = $this->callProviderApi('GET', 'topup/ding/providers', $params);
                    break;
                case 'regions':
                    $params['countryIsos'] = $request->countryIso;
                    $params['countryCode'] = $request->countryCode;
                    $result = $this->callProviderApi('GET', 'topup/ding/regions', $params);
                    break;
                case 'products':
                    $params['accountNumber'] = $accountNumber;
                    $params['countryCode'] = $request->countryCode;
                    ...
                    $result = $this->callProviderApi('GET', 'topup/ding/products', $params);
                    break;
                case 'estimate':
                    $params = [
                    ...
                    $result = $this->callProviderApi('GET', 'topup/ding/estimate', $params);
                    break;
            }
            return $result;
    ...
    public function confirm(Request $request)
    {
        ...
        try {
            ...
            AppHelper::logger('warning', 'Ding TamaTopup V2 API', 'Ding TamaTopup API HTTP Status ' . $e->getCode(), $responseBodyAsString, true);
